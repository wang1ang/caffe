 ...
 protected:
  WeightedSigmoidCrossEntropyLossLayerTest()
      : blob_bottom_data_(new Blob<Dtype>(10, 5, 1, 1)),
        ...
        blob_bottom_sample_weights_(new Blob<Dtype>(10, 5, 1, 1)),
    ...
    // Fill sample weights
    FillerParameter sample_weights_filler_param;
    sample_weights_filler_param.set_min(0);
    sample_weights_filler_param.set_max(1);
    UniformFiller<Dtype> sample_weights_filler(sample_weights_filler_param);
    sample_weights_filler.Fill(blob_bottom_sample_weights_);
    blob_bottom_vec_.push_back(blob_bottom_sample_weights_);
    // Add top data
  ...
  virtual ~WeightedSigmoidCrossEntropyLossLayerTest() {
    ...
    delete blob_bottom_sample_weights_;
  ...
  Blob<Dtype>* const blob_bottom_sample_weights_;
