...
template <typename Dtype>
void HypercolumnExtractorLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void HypercolumnExtractorLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
      const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom) {
  Backward_cpu(top, propagate_down, bottom);
}

template <>
void HypercolumnExtractorLayer<float>::Backward_gpu(const vector<Blob<float>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(HypercolumnExtractorLayer);
